...
export function SdgTabel() {
    ...
    const handleDelete = async (id) => {
        ...
        if (result.value) {
            try {
                const response = await axios.delete(`http://sbc-sebatcabut.herokuapp.com/sumberdayageologi/${id}`, {
                    headers: {
                ...
                <Card>
                    <CardHeader variant="gradient" color="blue" className="mb-8 p-6">
                        <Typography variant="h6" color="white">
                            Sumber Daya Geologi - 6.02.02.99.999
                        </Typography>
                    </CardHeader>
                                ...
                                {data &&
                                    data.map((item) => (
                                        <tr className="border-b border-blue-gray-50 py-3 px-5 text-left" key={item}>{item.id.toUpperCase()}
                                            ...
                                            <td className="border-b border-blue-gray-50 py-3 px-5 text-left">
                                                <a href={`sdgedit/${item.id}`}><Button className="flex gap-2 bg-blue-gray-900" ><PencilSquareIcon className="w-5" />Edit</Button></a>
                                            </td>
                                            <td className="border-b border-blue-gray-50 py-3 px-5 text-left">
